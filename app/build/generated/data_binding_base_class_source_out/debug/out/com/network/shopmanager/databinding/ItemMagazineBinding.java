...
public final class ItemMagazineBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView magazineName;

  private ItemMagazineBinding(@NonNull LinearLayout rootView, @NonNull ImageView buttonMore,
      @NonNull TextView magazineName) {
  ...
  public static ItemMagazineBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.magazine_name;
      TextView magazineName = ViewBindings.findChildViewById(rootView, id);
      if (magazineName == null) {
        break missingId;
      }

      return new ItemMagazineBinding((LinearLayout) rootView, buttonMore, magazineName);
    }
